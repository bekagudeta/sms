...
Route::middleware(['auth'])->group(function () {
    ...
    Route::middleware(['permission:import data'])->group(function () {
        ...
        // One-time download of credentials generated by the last student/teacher import
        Route::get('/import/credentials/download', [ImportController::class, 'downloadCredentials'])
            ->name('import.credentials.download');
